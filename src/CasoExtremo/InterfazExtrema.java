 ...
 * Clase Interfaz donde aplicamos los datos
 */
public class InterfazExtrema extends javax.swing.JFrame {

    /**
     * Creates new form InterfazSecuencial
     */
    public InterfazExtrema() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Calculo matriz extrema");
    ...
    /**
     * Metodo donde se implementa la accion a ejecutar al pulsar el boton
     * @param evt 
     */
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        ...
        ProyectoExtremo p = new ProyectoExtremo(matriz, matriz1, mult);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazExtrema.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazExtrema().setVisible(true);
            }
        });
    }
